const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(KYUREM_W, gMonBackPic_KyuremW),
    SPECIES_SPRITE(KYUREM_B, gMonBackPic_KyuremB),
    SPECIES_SPRITE(KELDEO, gMonBackPic_Keldeo),
    SPECIES_SPRITE(MELOETTA_A, gMonBackPic_MeloettaA),
    SPECIES_SPRITE(MELOETTA_P, gMonBackPic_MeloettaP),
