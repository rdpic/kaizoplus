...
extern const u32 gMonFrontPic_Porygon_Z[];
extern const u32 gMonPalette_Porygon_Z[];
extern const u32 gMonBackPic_Porygon_Z[];
extern const u32 gMonShinyPalette_Porygon_Z[];
extern const u8 gMonIcon_Porygon_Z[];
extern const u8 gMonFootprint_Porygon_Z[];
...
extern const u32 gMonFrontPic_KyuremW[];
extern const u32 gMonPalette_KyuremW[];
extern const u32 gMonBackPic_KyuremW[];
extern const u32 gMonShinyPalette_KyuremW[];
extern const u8 gMonIcon_KyuremW[];
extern const u8 gMonFootprint_KyuremW[];
extern const u32 gMonFrontPic_KyuremB[];
extern const u32 gMonPalette_KyuremB[];
extern const u32 gMonBackPic_KyuremB[];
extern const u32 gMonShinyPalette_KyuremB[];
extern const u8 gMonIcon_KyuremB[];
extern const u8 gMonFootprint_KyuremB[];
...
extern const u32 gMonFrontPic_MeloettaA[];
extern const u32 gMonPalette_MeloettaA[];
extern const u32 gMonBackPic_MeloettaA[];
extern const u32 gMonShinyPalette_MeloettaA[];
extern const u8 gMonIcon_MeloettaA[];
extern const u8 gMonFootprint_MeloettaA[];
extern const u32 gMonFrontPic_MeloettaP[];
extern const u32 gMonPalette_MeloettaP[];
extern const u32 gMonBackPic_MeloettaP[];
extern const u32 gMonShinyPalette_MeloettaP[];
extern const u8 gMonIcon_MeloettaP[];
extern const u8 gMonFootprint_MeloettaP[];
