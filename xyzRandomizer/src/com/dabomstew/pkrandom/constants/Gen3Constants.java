...
public class Gen3Constants {
    ...
    public static final List<Integer> soundMoves = Arrays.asList(Moves.growl, Moves.roar, Moves.sing, Moves.supersonic,
            ...
            Moves.perishSong, Moves.healBell, Moves.bugBuzz, Moves.chatter, Moves.roarOfTime, Moves.round, Moves.echoedVoice,
            Moves.relicSong, Moves.snarl, Moves.disarmingVoice, Moves.boomburst, Moves.alluringVoice);
