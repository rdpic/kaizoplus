...
static const u16 sEasyChatWordsByLetter_A[] = {
    ...
    EC_MOVE2(ARM_THRUST),
    EC_POKEMON2(ARMALDO),
    EC_POKEMON2(ARMAROUGE),
    EC_MOVE(AROMATHERAPY),
    EC_POKEMON2(AROMATISSE),
    EC_POKEMON2(ARON),
    EC_WORD_AROUND,
    EC_WORD_ARRGH,
    EC_POKEMON(ARTICUNO),
...
static const u16 sEasyChatWordsByLetter_C[] = {
    ...
    EC_POKEMON(CELEBI),
    EC_WORD_CENTER,
    EC_POKEMON2(CERULEDGE),
    EC_WORD_CHALLENGE,
    EC_POKEMON2(CHANDELURE),
    EC_WORD_CHANGE,
    EC_WORD_CHANNEL,
    EC_POKEMON(CHANSEY),
    EC_POKEMON2(CHARCADET),
    EC_MOVE(CHARGE),
    ...
    EC_WORD_CHOOSE,
    EC_WORD_CHORES,
    EC_POKEMON2(CINCCINO),
    EC_MOVE(CLAMP),
    EC_POKEMON2(CLAMPERL),
    EC_WORD_CLASS,
    EC_POKEMON2(CLAUNCHER),
    EC_POKEMON2(CLAWITZER),
    EC_POKEMON2(CLAYDOL),
    EC_WORD_CLEAR_BODY,
    EC_POKEMON(CLEFABLE),
    EC_POKEMON(CLEFAIRY),
    ...
    EC_WORD_CLOUD_NINE,
    EC_POKEMON(CLOYSTER),
    EC_POKEMON2(COBALION),
    EC_POKEMON2(COFAGRIGUS),
    EC_WORD_COLD,
    EC_WORD_COLLECT,
    EC_WORD_COLLECTION,
    EC_WORD_COLOR,
...
static const u16 sEasyChatWordsByLetter_D[] = {
    ...
    EC_WORD_DOWN,
    EC_WORD_DOWNCAST,
    EC_POKEMON2(DRAGALGE),
    EC_POKEMON2(DRAGAPULT),
    EC_WORD_DRAGON,
    ...
    EC_POKEMON2(DRAKLOAK),
    EC_POKEMON2(DRAPION),
    EC_POKEMON(DRATINI),
    EC_WORD_DREAM,
    EC_MOVE2(DREAM_EATER),
    EC_POKEMON2(DREEPY),
    EC_POKEMON2(DRIFBLIM),
    EC_POKEMON2(DRIFLOON),
    EC_POKEMON2(DRILBUR),
    EC_MOVE2(DRILL_PECK),
    EC_WORD_DRINK,
    EC_WORD_DRINKS,
    ...
    EC_WORD_DROUGHT,
    EC_POKEMON(DROWZEE),
    EC_POKEMON2(DRUDDIGON),
    EC_POKEMON2(DUCKLETT),
    EC_WORD_DUDE,
    EC_POKEMON(DUGTRIO),
...
static const u16 sEasyChatWordsByLetter_E[] = {
    ...
    EC_WORD_EATS,
    EC_WORD_EEK,
    EC_POKEMON2(EELEKTRIK),
    EC_POKEMON2(EELEKTROSS),
    EC_POKEMON(EEVEE),
...
static const u16 sEasyChatWordsByLetter_F[] = {
    ...
    EC_WORD_FLATTEN,
    EC_MOVE(FLATTER),
    EC_POKEMON2(FLETCHINDER),
    EC_POKEMON2(FLETCHLING),
    EC_POKEMON2(FLOATZEL),
    EC_POKEMON2(FLOETTE),
    EC_POKEMON2(FLORGES),
    EC_WORD_FLOWERS,
    EC_POKEMON2(FLUTTER_MANE),
    EC_MOVE(FLY),
    EC_POKEMON2(FLYGON),
    EC_WORD_FLYING,
...
static const u16 sEasyChatWordsByLetter_G[] = {
    ...
    EC_POKEMON(GASTLY),
    EC_POKEMON2(GASTRODON),
    EC_POKEMON2(GENESECT),
    EC_POKEMON(GENGAR),
    EC_WORD_GENIUS,
    -1, 2, // Doubled pokemon species name
    EC_POKEMON2(GEODUDE),
...
static const u16 sEasyChatWordsByLetter_H[] = {
    ...
    EC_WORD_HEHE,
    EC_WORD_HEHEHE,
    EC_POKEMON2(HELIOLISK),
    EC_POKEMON2(HELIOPTILE),
    EC_WORD_HELLO,
    ...
    EC_WORD_HIM,
    EC_WORD_HIP_AND,
    EC_POKEMON2(HIPPOPOTAS),
    EC_POKEMON2(HIPPOWDON),
    EC_WORD_HIS,
    EC_WORD_HIT,
...
static const u16 sEasyChatWordsByLetter_K[] = {
    ...
    EC_WORD_KTHX_BYE,
    EC_POKEMON2(KYOGRE),
    EC_POKEMON2(KYUREM_B),
    EC_POKEMON2(KYUREM_W),
};
...
static const u16 sEasyChatWordsByLetter_L[] = {
    ...
    EC_WORD_LALALA,
    EC_POKEMON2(LAMPENT),
    EC_POKEMON2(LANDORUS),
    -1, 2, // Doubled pokemon species name
    EC_POKEMON2(LANTURN),
    EC_POKEMON(LANTURN),
    EC_POKEMON(LAPRAS),
    EC_POKEMON2(LARVESTA),
    EC_POKEMON(LARVITAR),
    EC_WORD_LAST,
    EC_WORD_LATE,
    EC_WORD_LATER,
    ...
    EC_WORD_LIKES,
    EC_POKEMON2(LILEEP),
    EC_POKEMON2(LILLIGANT),
    EC_POKEMON2(LILLIPUP),
    EC_WORD_LIMBER,
    EC_WORD_LINK,
    EC_POKEMON2(LINOONE),
    EC_WORD_LIQUID_OOZE,
...
static const u16 sEasyChatWordsByLetter_M[] = {
    ...
    EC_MOVE2(MEGAHORN),
    EC_POKEMON(MEGANIUM),
    EC_POKEMON2(MELOETTA_A),
    EC_POKEMON2(MELOETTA_P),
    EC_MOVE(MEMENTO),
    EC_POKEMON2(MEOWSTIC),
    EC_POKEMON(MEOWTH),
    EC_POKEMON2(MESPRIT),
    EC_WORD_MESSAGE,
    ...
    EC_POKEMON2(MUK),
    EC_POKEMON(MUK),
    EC_POKEMON2(MUNCHLAX),
    EC_POKEMON2(MUNNA),
    EC_POKEMON(MURKROW),
    EC_POKEMON2(MUSHARNA),
    EC_WORD_MUSIC,
    EC_WORD_MUST_BE,
    EC_WORD_MY,
    EC_WORD_MYSELF,
...
static const u16 sEasyChatWordsByLetter_P[] = {
    ...
    EC_WORD_PRETEND,
    EC_WORD_PRETTY,
    EC_POKEMON2(PRIMARINA),
    EC_POKEMON(PRIMEAPE),
    EC_POKEMON2(PRINPLUP),
    EC_WORD_PROBABLY,
    EC_POKEMON2(PROBOPASS),
    EC_WORD_PROMISE,
    EC_MOVE2(PROTECT),
    EC_MOVE(PSYBEAM),
    EC_MOVE(PSYCH_UP),
...
static const u16 sEasyChatWordsByLetter_R[] = {
    ...
    EC_WORD_REFUSE,
    EC_POKEMON2(REGICE),
    EC_POKEMON2(REGIDRAGO),
    EC_POKEMON2(REGIELEKI),
    ...
    EC_POKEMON(REMORAID),
    EC_WORD_RENTAL,
    EC_POKEMON2(RESHIRAM),
    EC_MOVE2(REST),
    EC_WORD_RESUSCITATE,
    EC_MOVE(RETURN),
    EC_POKEMON2(REUNICLUS),
    EC_MOVE2(REVENGE),
    EC_MOVE(REVERSAL),
    -1, 2, // Doubled pokemon species name
    EC_POKEMON2(RHYDON),
...
static const u16 sEasyChatWordsByLetter_S[] = {
    ...
    EC_WORD_SATURDAY,
    EC_POKEMON2(SAWK),
    EC_POKEMON2(SAWSBUCK),
    EC_WORD_SAYS,
    EC_WORD_SCARY,
    EC_MOVE(SCARY_FACE),
    EC_WORD_SCATTER,
    EC_POKEMON2(SCATTERBUG),
    ...
    EC_WORD_SERIOUS,
    EC_WORD_SERIOUSLY,
    EC_POKEMON2(SERPERIOR),
    EC_WORD_SERVICE,
    EC_POKEMON2(SERVINE),
    EC_POKEMON2(SEVIPER),
    EC_POKEMON2(SEWADDLE),
    EC_MOVE(SHADOW_BALL),
    ...
    EC_WORD_SIBLINGS,
    EC_WORD_SIGH,
    EC_POKEMON2(SIGILYPH),
    EC_MOVE(SIGNAL_BEAM),
    EC_POKEMON2(SILCOON),
    EC_WORD_SILKY,
    EC_WORD_SILVER,
    EC_MOVE(SILVER_WIND),
    EC_POKEMON2(SIMIPOUR),
    EC_POKEMON2(SIMISAGE),
    EC_POKEMON2(SIMISEAR),
    EC_WORD_SIMPLE,
    EC_WORD_SINCE,
    EC_MOVE(SING),
    EC_WORD_SINK,
    ...
    EC_WORD_SPORTS,
    EC_WORD_SPRING,
    EC_POKEMON2(SPRITZEE),
    EC_POKEMON(SQUIRTLE),
    EC_WORD_STAGE,
    EC_POKEMON(STANTLER),
    EC_POKEMON2(STARAPTOR),
    EC_POKEMON2(STARAVIA),
    EC_POKEMON2(STARLY),
    -1, 2, // Doubled pokemon species name
    EC_POKEMON2(STARMIE),
    EC_POKEMON(STARMIE),
...
static const u16 sEasyChatWordsByLetter_V[] = {
    ...
    EC_MOVE2(VINE_WHIP),
    EC_POKEMON2(VIRIZION),
    EC_WORD_VITAL_SPIRIT,
    EC_MOVE(VITAL_THROW),
    EC_POKEMON2(VIVILLON),
    EC_POKEMON2(VOLBEAT),
    EC_POKEMON2(VOLCANION),
...
static const u16 sEasyChatWordsByLetter_W[] = {
    ...
    EC_WORD_WHICH,
    EC_WORD_WHILE,
    EC_POKEMON2(WHIMSICOTT),
    EC_POKEMON2(WHIRLIPEDE),
    EC_MOVE(WHIRLPOOL),
    EC_MOVE2(WHIRLWIND),
