const u8 *const gMonFootprintTable[] =
{
    ...
    [SPECIES_KYUREM_W] = gMonFootprint_KyuremW,
    [SPECIES_KYUREM_B] = gMonFootprint_KyuremB,
    [SPECIES_KELDEO] = gMonFootprint_Keldeo,
    [SPECIES_MELOETTA_A] = gMonFootprint_MeloettaA,
    [SPECIES_MELOETTA_P] = gMonFootprint_MeloettaP,
