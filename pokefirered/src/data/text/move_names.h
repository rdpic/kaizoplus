const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] = {
    ...
    [MOVE_PETAL_BLIZZARD] = _("PETAL BLIZZ."),
    ...
    [MOVE_GRASSY_TERRAIN] = _("GRASSY T."),
    [MOVE_MISTY_TERRAIN]  = _("MISTY T."),
    [MOVE_PSYCHIC_TERRAIN] = _("PSYCHIC T."),
    [MOVE_ELECTRIC_TERRAIN] = _("ELECTRIC T."),
    [MOVE_DAZZLING_GLEAM] = _("DAZZLIN GLEAM"),
    [MOVE_CELEBRATE]    = _("CELEBRATE"),
    [MOVE_HOLD_HANDS]   = _("HOLD HANDS"),
    [MOVE_BABY_DOLL_EYES]   = _("B-DOLL EYES"),
    [MOVE_NUZZLE]   = _("NUZZLE"),
    [MOVE_HOLD_BACK]   = _("NUZZLE"),
    ...
    [MOVE_POWER_UP_PUNCH] = _("PWR-UP PUNCH"),
    [MOVE_ALLURING_VOICE] = _("ALLURE VOICE"),
    ...
    [MOVE_MISTY_EXPLOSION] = _("M. EXPLOSION"),
    [MOVE_LIQUIDATION] = _("LIQUIDATION"),
    [MOVE_TRIPLE_AXEL] = _("TRIPLE AXEL"),
    [MOVE_CHROMA_BLADES] = _("CHROMA BLADES"),
    [MOVE_LIGHT_SLASH] = _("LIGHT SLASH"),
    [MOVE_LUNAR_PUNCH] = _("LUNAR PUNCH"),
    [MOVE_MOON_BREAK] = _("MOON BREAK"),
    [MOVE_DUAL_FLICK] = _("DUAL FLICK"),
    [MOVE_OBLIVION_WING] = _("OBLIVION WING"),
    [MOVE_THOUSAND_WAVES] = _("THOUSAND W."),
