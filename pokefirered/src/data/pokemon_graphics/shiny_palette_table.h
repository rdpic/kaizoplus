const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(PORYGON_Z, gMonShinyPalette_Porygon_Z),
    ...
    SPECIES_SHINY_PAL(KYUREM_W, gMonShinyPalette_KyuremW),
    SPECIES_SHINY_PAL(KYUREM_B, gMonShinyPalette_KyuremB),
    SPECIES_SHINY_PAL(KELDEO, gMonShinyPalette_Keldeo),
    SPECIES_SHINY_PAL(MELOETTA_A, gMonShinyPalette_MeloettaA),
    SPECIES_SHINY_PAL(MELOETTA_P, gMonShinyPalette_MeloettaP),
