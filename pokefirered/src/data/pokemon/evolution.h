const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_PARAS]      = {{EVO_LEVEL, 12, SPECIES_PARASECT}},
    [SPECIES_VENONAT]    = {{EVO_LEVEL, 12, SPECIES_VENOMOTH}},
    [SPECIES_DIGLETT]    = {{EVO_LEVEL, 14, SPECIES_DUGTRIO}},
    [SPECIES_MEOWTH]     = {{EVO_LEVEL, 16, SPECIES_PERSIAN}},
    ...
    [SPECIES_POLIWAG]    = {{EVO_LEVEL, 14, SPECIES_POLIWHIRL}},
    ...
    [SPECIES_LICKITUNG]  = {{EVO_LEVEL, 18, SPECIES_LICKILICKY}},
    [SPECIES_KOFFING]    = {{EVO_LEVEL, 14, SPECIES_WEEZING}},
    [SPECIES_RHYHORN]    = {{EVO_LEVEL, 22, SPECIES_RHYDON}},
    ...
    [SPECIES_FLAAFFY]    = {{EVO_LEVEL, 22, SPECIES_AMPHAROS}},
    [SPECIES_MARILL]     = {{EVO_LEVEL, 18, SPECIES_AZUMARILL}},
    [SPECIES_HOPPIP]     = {{EVO_LEVEL, 16, SPECIES_SKIPLOOM}},
    [SPECIES_SKIPLOOM]   = {{EVO_LEVEL, 22, SPECIES_JUMPLUFF}},
    ...
    [SPECIES_PUPITAR]    = {{EVO_LEVEL, 30, SPECIES_TYRANITAR}},
    ...
    [SPECIES_NUMEL]      = {{EVO_LEVEL, 16, SPECIES_CAMERUPT}},
    ...
    [SPECIES_SWABLU]     = {{EVO_LEVEL, 14, SPECIES_ALTARIA}},
    ...
    [SPECIES_CLAMPERL]   = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_GOREBYSS}},
    ...
    [SPECIES_LUXIO]      = {{EVO_LEVEL, 22, SPECIES_LUXRAY}},
    ...
    [SPECIES_GIBLE]      = {{EVO_LEVEL, 22, SPECIES_GABITE}},
    ...
    [SPECIES_SANDILE]    = {{EVO_LEVEL, 14, SPECIES_KROKOROK}},
    [SPECIES_KROKOROK]   = {{EVO_LEVEL, 22, SPECIES_KROOKODILE}},   
    [SPECIES_DARUMAKA]   = {{EVO_LEVEL, 16, SPECIES_DARMANITAN}}, 
    [SPECIES_DWEBBLE]    = {{EVO_LEVEL, 14, SPECIES_CRUSTLE}},   
    [SPECIES_SCRAGGY]    = {{EVO_LEVEL, 16, SPECIES_SCRAFTY}},
    [SPECIES_YAMASK]     = {{EVO_LEVEL, 16, SPECIES_COFAGRIGUS}},
    [SPECIES_TIRTOUGA]   = {{EVO_LEVEL, 20, SPECIES_CARRACOSTA}},
    [SPECIES_ARCHEN]     = {{EVO_LEVEL, 20, SPECIES_ARCHEOPS}},
    [SPECIES_TRUBBISH]   = {{EVO_LEVEL, 14, SPECIES_GARBODOR}},
    [SPECIES_ZORUA]      = {{EVO_LEVEL, 14, SPECIES_ZOROARK}},
    [SPECIES_MINCCINO]   = {{EVO_ITEM, ITEM_SHINY_STONE, SPECIES_CINCCINO}},
    [SPECIES_GOTHITA]    = {{EVO_FRIENDSHIP, 0, SPECIES_GOTHORITA}},
    [SPECIES_GOTHORITA]  = {{EVO_LEVEL, 22, SPECIES_GOTHITELLE}},
    [SPECIES_SOLOSIS]    = {{EVO_FRIENDSHIP, 0, SPECIES_DUOSION}},
    [SPECIES_DUOSION]    = {{EVO_LEVEL, 22, SPECIES_REUNICLUS}},
    [SPECIES_DUCKLETT]   = {{EVO_LEVEL, 16, SPECIES_SWANNA}},
    [SPECIES_VANILLITE]  = {{EVO_FRIENDSHIP, 0, SPECIES_VANILLISH}},
    [SPECIES_VANILLISH]  = {{EVO_LEVEL, 22, SPECIES_VANILLUXE}},
    [SPECIES_DEERLING]   = {{EVO_LEVEL, 16, SPECIES_SAWSBUCK}},
    [SPECIES_KARRABLAST] = {{EVO_LEVEL, 10, SPECIES_ESCAVALIER}},
    [SPECIES_FOONGUS]    = {{EVO_LEVEL, 10, SPECIES_AMOONGUSS}},
    [SPECIES_FRILLISH]   = {{EVO_LEVEL, 16, SPECIES_JELLICENT}},
    [SPECIES_JOLTIK]     = {{EVO_LEVEL, 16, SPECIES_GALVANTULA}},
    [SPECIES_FERROSEED]  = {{EVO_LEVEL, 14, SPECIES_FERROTHORN}},
    [SPECIES_KLINK]      = {{EVO_LEVEL, 16, SPECIES_KLANG}},
    [SPECIES_KLANG]      = {{EVO_LEVEL, 30, SPECIES_KLINKLANG}},
    [SPECIES_TYNAMO]     = {{EVO_FRIENDSHIP, 0, SPECIES_EELEKTRIK}},
    [SPECIES_EELEKTRIK]  = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_EELEKTROSS}},
    [SPECIES_ELGYEM]     = {{EVO_LEVEL, 16, SPECIES_BEHEEYEM}},
    [SPECIES_LITWICK]    = {{EVO_LEVEL, 14, SPECIES_LAMPENT}},
    [SPECIES_LAMPENT]    = {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_CHANDELURE}},
    [SPECIES_AXEW]       = {{EVO_LEVEL, 22, SPECIES_FRAXURE}},
    [SPECIES_FRAXURE]    = {{EVO_LEVEL, 45, SPECIES_HAXORUS}},
    [SPECIES_CUBCHOO]    = {{EVO_LEVEL, 14, SPECIES_BEARTIC}},
    [SPECIES_SHELMET]    = {{EVO_LEVEL, 10, SPECIES_ACCELGOR}},
    [SPECIES_MIENFOO]    = {{EVO_LEVEL, 16, SPECIES_MIENSHAO}},
    [SPECIES_GOLETT]     = {{EVO_LEVEL, 14, SPECIES_GOLURK}},
    [SPECIES_PAWNIARD]   = {{EVO_LEVEL, 16, SPECIES_BISHARP}},
    [SPECIES_RUFFLET]    = {{EVO_LEVEL, 16, SPECIES_BRAVIARY}},
    [SPECIES_VULLABY]    = {{EVO_LEVEL, 16, SPECIES_MANDIBUZZ}},
    [SPECIES_DEINO]      = {{EVO_LEVEL, 22, SPECIES_ZWEILOUS}},
    [SPECIES_ZWEILOUS]   = {{EVO_LEVEL, 45, SPECIES_HYDREIGON}},
    [SPECIES_LARVESTA]   = {{EVO_LEVEL, 16, SPECIES_VOLCARONA}},
    [SPECIES_CHESPIN]    = {{EVO_LEVEL, 16, SPECIES_QUILLADIN}},
    [SPECIES_QUILLADIN]  = {{EVO_LEVEL, 30, SPECIES_CHESNAUGHT}},
    [SPECIES_FENNEKIN]   = {{EVO_LEVEL, 16, SPECIES_BRAIXEN}},
    [SPECIES_BRAIXEN]    = {{EVO_LEVEL, 30, SPECIES_DELPHOX}},
    [SPECIES_FROAKIE]    = {{EVO_LEVEL, 16, SPECIES_FROGADIER}},
    [SPECIES_FROGADIER]  = {{EVO_LEVEL, 30, SPECIES_GRENINJA}},
    [SPECIES_BUNNELBY]   = {{EVO_LEVEL, 14, SPECIES_DIGGERSBY}},
    [SPECIES_FLETCHLING] = {{EVO_LEVEL, 14, SPECIES_FLETCHINDER}},
    [SPECIES_FLETCHINDER]= {{EVO_LEVEL, 22, SPECIES_TALONFLAME}},
    [SPECIES_SCATTERBUG] = {{EVO_LEVEL, 7, SPECIES_SPEWPA}},
    [SPECIES_SPEWPA]     = {{EVO_LEVEL, 10, SPECIES_VIVILLON}},
    [SPECIES_LITLEO]     = {{EVO_LEVEL, 16, SPECIES_PYROAR}},
    [SPECIES_FLABEBE]    = {{EVO_FRIENDSHIP, 0, SPECIES_FLOETTE}},
    [SPECIES_FLOETTE]    = {{EVO_ITEM, ITEM_SHINY_STONE, SPECIES_FLORGES}},
    [SPECIES_SKIDDO]     = {{EVO_LEVEL, 16, SPECIES_GOGOAT}},
    [SPECIES_PANCHAM]    = {{EVO_LEVEL, 16, SPECIES_PANGORO}},
    [SPECIES_ESPURR]     = {{EVO_LEVEL, 16, SPECIES_MEOWSTIC}},
    [SPECIES_HONEDGE]    = {{EVO_LEVEL, 16, SPECIES_DOUBLADE}},
    [SPECIES_DOUBLADE]   = {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_AEGISLASH}},
    [SPECIES_SPRITZEE]   = {{EVO_FRIENDSHIP, 0, SPECIES_AROMATISSE}},
    [SPECIES_SWIRLIX]    = {{EVO_FRIENDSHIP, 0, SPECIES_SLURPUFF}},
    [SPECIES_INKAY]      = {{EVO_FRIENDSHIP, 0, SPECIES_MALAMAR}},
    [SPECIES_BINACLE]    = {{EVO_LEVEL, 14, SPECIES_BARBARACLE}},
    [SPECIES_SKRELP]     = {{EVO_LEVEL, 20, SPECIES_DRAGALGE}},
    [SPECIES_CLAUNCHER]  = {{EVO_LEVEL, 16, SPECIES_CLAWITZER}},
    [SPECIES_HELIOPTILE] = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_HELIOLISK}},
    [SPECIES_TYRUNT]     = {{EVO_LEVEL, 20, SPECIES_TYRANTRUM}},
    [SPECIES_AMAURA]     = {{EVO_LEVEL, 16, SPECIES_AURORUS}},
    [SPECIES_GOOMY]      = {{EVO_FRIENDSHIP, 0, SPECIES_SLIGGOO}},
    ...
    [SPECIES_BERGMITE]   = {{EVO_ITEM, ITEM_ICE_STONE, SPECIES_AVALUGG}},
    [SPECIES_NOIBAT]     = {{EVO_FRIENDSHIP, 0, SPECIES_NOIVERN}},
    [SPECIES_DREEPY]     = {{EVO_LEVEL, 18, SPECIES_DRAKLOAK}},
    [SPECIES_DRAKLOAK]   = {{EVO_LEVEL, 40, SPECIES_DRAGAPULT}},
    [SPECIES_CHARCADET]  = {{EVO_FRIENDSHIP, 0, SPECIES_ARMAROUGE}},
};
