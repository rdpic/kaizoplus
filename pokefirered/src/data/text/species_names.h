const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_KYUREM_W] = _("KYUREM-W"),
    [SPECIES_KYUREM_B] = _("KYUREM-B"),
    [SPECIES_KELDEO] = _("KELDEO"),
    [SPECIES_MELOETTA_A] = _("MELOETTA"),
    [SPECIES_MELOETTA_P] = _("MELOETTA-P"),
    ...
    [SPECIES_FLUTTER_MANE] = _("FLUTTER-M"),
    [SPECIES_IRON_VALIANT] = _("IRON-VAL"),
