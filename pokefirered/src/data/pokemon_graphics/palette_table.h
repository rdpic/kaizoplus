const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(PORYGON_Z, gMonPalette_Porygon_Z),
    ...
    SPECIES_PAL(KYUREM_W, gMonPalette_KyuremW),
    SPECIES_PAL(KYUREM_B, gMonPalette_KyuremB),
    SPECIES_PAL(KELDEO, gMonPalette_Keldeo),
    SPECIES_PAL(MELOETTA_A, gMonPalette_MeloettaA),
    SPECIES_PAL(MELOETTA_P, gMonPalette_MeloettaP),
