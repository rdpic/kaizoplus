const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(PORYGON_Z, gMonFrontPic_Porygon_Z),
    ...
    SPECIES_SPRITE(KYUREM_W, gMonFrontPic_KyuremW),
    SPECIES_SPRITE(KYUREM_B, gMonFrontPic_KyuremB),
    SPECIES_SPRITE(KELDEO, gMonFrontPic_Keldeo),
    SPECIES_SPRITE(MELOETTA_A, gMonFrontPic_MeloettaA),
    SPECIES_SPRITE(MELOETTA_P, gMonFrontPic_MeloettaP),
